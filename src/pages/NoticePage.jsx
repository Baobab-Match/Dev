...
const NOTICES = [
  {
    ...
    title: "AI 모델 고도화 안내",
    date: "2026-08-02",
    body: "매칭 결과를 산출하는 AI 로직이 개선되었습니다. 국가별 협력 용이성 지표에 통계 분석(주성분분석)을 반영해 신뢰도를 높였고, 기업 회원의 수출경험을 반영하는 요소가 새로 추가되어 관련 기업에는 더 정교한 추천이 제공됩니다. 아울러 전체 국가·분야·회원유형 조합의 실제 매칭 점수 분포를 분석해, 매칭 점수(0~100점)와 적합도 등급(매우 적합·적합·보통·참고) 기준을 실제 데이터에 맞춰 다시 정비했습니다.",
  },
  ...
  {
    id: 9,
    title: "국가 상세 페이지 인프라 정보 확대 및 PDF 보고서 페이지 구성 개선",
    date: "2026-07-29",
